        ...
        <View style={{ flex: 1, marginTop: 0, backgroundColor: '#0f4571', }}>
          ...
          >
           <Ionicons style={{marginLeft:5, marginRight:5}} name="caret-back-outline" size={35} color="#FFF"></Ionicons>
            ...
            <View>
                <Text style={styles.TitleInputs}>Sua idade:</Text>
                <TextInput
                    placeholder="Idade somente numero"
            ...
            <View>
                <Text style={styles.TitleInputs}>Seu CPF:</Text>
                <TextInput
            ...
            <View>
                <Text style={styles.TitleInputs}>Curso inscrito:</Text>
                <TextInput
                    placeholder="DS"
